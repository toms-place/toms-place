...
- [helmfile/helmfile](https://github.com/helmfile/helmfile) ([v1.8.0](https://github.com/helmfile/helmfile/releases/tag/v1.8.0), 3 days ago) - Declaratively deploy your Kubernetes manifests, Kustomize configs, and Charts as Helm releases. Generate all-in-one manifests for use with ArgoCD.
