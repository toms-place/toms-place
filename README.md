...
- [jkroepke/helm-secrets](https://github.com/jkroepke/helm-secrets) ([v4.6.11](https://github.com/jkroepke/helm-secrets/releases/tag/v4.6.11), 2 days ago) - A helm plugin that help manage secrets with Git workflow and store them anywhere
...
- [pocket-id/pocket-id](https://github.com/pocket-id/pocket-id) - A simple and easy-to-use OIDC provider that allows users to authenticate with their passkeys to your services. (4 weeks ago)
- [lldap/lldap](https://github.com/lldap/lldap) - Light LDAP implementation (4 weeks ago)
