...
- [VereinLebenslicht/pages-at](https://github.com/VereinLebenslicht/pages-at) -  (1 week ago)
...
- [jkroepke/helm-secrets](https://github.com/jkroepke/helm-secrets) ([v4.6.9](https://github.com/jkroepke/helm-secrets/releases/tag/v4.6.9), 6 days ago) - A helm plugin that help manage secrets with Git workflow and store them anywhere
...
- [sadoyan/aralez](https://github.com/sadoyan/aralez) - Aralez (Արալեզ), Reverse proxy and service mesh built on top of Cloudflare's Pingora (3 days ago)
...
- [dmno-dev/varlock](https://github.com/dmno-dev/varlock) - .env files built for sharing powered by @env-spec decorator comments (3 weeks ago)
