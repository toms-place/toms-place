...
- [jkroepke/helm-secrets](https://github.com/jkroepke/helm-secrets) ([v4.7.4](https://github.com/jkroepke/helm-secrets/releases/tag/v4.7.4), 2 days ago) - A helm plugin that help manage secrets with Git workflow and store them anywhere
...
- [elastic/elastic-package](https://github.com/elastic/elastic-package) - elastic-package - Command line tool for developing Elastic Integrations (3 weeks ago)
